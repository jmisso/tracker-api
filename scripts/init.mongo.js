 ...
 * Run using the mongo shell. For remote databases, ensure that the connection string
 is supplied in the command
line. For example:
 * localhost:
 *   mongo issuetracker scripts/init.mongo.js
 * Atlas:
 * * mongo mongodb+srv://user:pwd@xxx.mon- godb.net/issuetracker
 * scripts/init.mongo.js
 * MLab:
 * mongo mon- godb://user:pwd@xxx.mlab.com:33533/issuetracker scripts/init.mongo.js
*/
